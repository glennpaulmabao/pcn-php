...
<body>
    ...
    <div class="pcn-hero" style="background-image: url(./assets/images/Education-herobg.png); width: 100%; background-size: cover; background-position: center;">        
    ...
    <div class="container-fluid educ-form-bg" style="margin: 0px">
