...
<body>
    ...
    <div class="pcn-hero" style="background-image: url(./assets/images/higher-ed-herobg.png); width: 100%; background-size: cover; background-position: center;">        
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12">
            <img src="./assets/images/HE-OffersBG.png" width="100%" height="100%" alt="">
        </div>
        <div class="col-lg-6 col-sm-12 pcn-mr" style="margin: auto 0px;">
            ...
            <div class="pcn-list">
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> High-density Wi-Fi</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Holistic network assessment</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Outsourced network management</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Guest network access</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Integrated cybersecurity</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Fast and reliable speeds</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Virtualization and remote access</li>
                <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Servers and storage</li>
            </div>
        </div>
    </div>

    <div class="container" style="margin: 10% auto; text-align: center;">
        <h1 style="text-transform: none; font-size: 35px; margin: 2% 10%; width: 80%; font-weight: 300;" >Cloud services for higher education</h1>
        <p style="font-weight: 200; font-size: 18px;" >The cloud has unique benefits — like scaling quickly during peak times, such as enrollment and finals. We’ll help you establish the right workload alignment and management practices, so you can take full advantage of the cloud’s power and flexibility.</p>
    </div>
    ...
    <div class="solutions container">
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <div class="shadow solutions-box">
                    <img src="./assets/images/icons/hesolutionicon1.png" height="46px" width="auto" style="margin: 3% 0;" alt="">
                <h1 style="font-weight: 300; font-size: 25px;" style="margin: 0 0 1% 0;">Cloud assessments 
                    and workshops</h1>
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="shadow solutions-box">
                    <img src="./assets/images/icons/hesolutionicon2.png" height="46px" width="auto" style="margin: 3% 0;" alt="">
                    <h1 style="font-weight: 300; font-size: 25px;" style="margin: 0 0 1% 0;">Consolidation 
                        and migration services</h1>
                    <p style="color: black; margin: 5% 0 0 0;">Eliminate redundancies, simplify operations and accelerate performance by upgrading existing data centers and migrating to best-fit platforms</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <div class="shadow solutions-box">
                    <img src="./assets/images/icons/hesolutionicon3.png" height="46px" width="auto" style="margin: 3% 0;" alt="">
                    <h1 style="font-weight: 300; font-size: 25px;" style="margin: 0 0 1% 0;">Cloud platform</h1>
                    <p style="color: black; margin: 5% 0 0 0;">A combination of public, private and hybrid clouds is ideal depending on your exact needs. We’ll help you property allocate your data and apps.</p>
                </div>
            </div>
    
            <div class="col-lg-6 col-sm-12">
                <div class="shadow solutions-box">
                    <img src="./assets/images/icons/hesolutionicon4.png" height="46px" width="auto" style="margin: 3% 0;" alt="">
                    <h1 style="font-weight: 300; font-size: 25px;" style="margin: 0 0 1% 0;">Data center 
                        management services</h1>
                    <p style="color: black; margin: 5% 0 0 0;">Maintaining peak operation and tight security requires careful attention. Ease your IT burden by offloading maintenance and monitoring.</p>
                </div>
            </div>
        </div>
    ...
    <div ID="ContactForm" class="container-fluid he-form-bg" style="margin: 10% 0 0 0;">
