    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" data-interval="2000">
        <div class="carousel-inner" style="height: 352px;">
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="./assets/images/HeroBG-1to1.png" style="width: 100%; height: 352px; background-size: cover; background-position: center;" alt="">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="./assets/images/HeroBG-1to1-slider2.png" style="width: 100%; height: 352px; background-size: cover; background-position: center;" alt="">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="./assets/images/HeroBG-1to1-slider3.png" style="width: 100%; height: 352px; background-size: cover; background-position: center;" alt="">
          </div>
        </div>
      </div>
    ...
    <div class="container">
        <div class="row" style="margin: 50px 0 150px 0;">
            ...
            <div class="col-lg-5 col-md-8 col-sm-12 btn-section">
                <div class="pcn-list">
                    <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Increase 21st Century Skills</li>
                    <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Increase Differentiated Learning</li>
                    <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Creators of Knowledge</li>
                    <li><img src="./assets/images/icons/CheckMark.png" height="22px" width="auto" style="margin: 0 1%;" alt=""> Increase Student Achievement</li>
                </div>
            </div>
        </div>
    </div>
